    ...
    */
    ...
    function renderChat() {
        return (
           ...
           {   webinarEnabled&&!isModerator ? <div></div>:(_isPollsEnabled && (
                    <>
                        <div
...
//         return (
//             <Tabs
//                 accessibilityLabel={t((webinarEnabled && !isModerator) ? 'chat.title' : 'chat.titleWithPolls')}
//                 onChange={onChangeTab}
//                 selected={_isPollsTabFocused ? CHAT_TABS.POLLS : CHAT_TABS.CHAT}
//                 tabs={tabs}
//             />
...
//         return (
//             <Tabs
//                 accessibilityLabel = { t((_isPollsEnabled &&!webinarEnabled )? 'chat.titleWithPolls' : 'chat.title') }
//                 onChange = { onChangeTab }
//                 selected = { _isPollsTabFocused &&!webinarEnabled? CHAT_TABS.POLLS : CHAT_TABS.CHAT }
//                 tabs={tabs}
