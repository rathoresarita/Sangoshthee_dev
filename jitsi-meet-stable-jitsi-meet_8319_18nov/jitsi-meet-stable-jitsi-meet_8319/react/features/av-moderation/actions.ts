...
import { clearNotifications, showNotification,showNotificationMod } from '../notifications/actions';
import { NOTIFICATION_TIMEOUT_TYPE } from '../notifications/constants';
import { Dispatch } from 'redux';
import {getModerator} from '../base/participants/functions'
...
export const requestDisableAudioandVideoModerationforWebinar = () => {
    
    return {
        type: REQUEST_DISABLE_AUDIO_MODERATION_FOR_WEBINAR
