...
export const REQUEST_DISABLE_AUDIO_MODERATION_FOR_WEBINAR = 'REQUEST_DISABLE_AUDIO_MODERATION_FOR_WEBINAR';
...
export const REQUEST_ENABLE_AUDIO_MODERATION_FOR_WEBINAR = 'REQUEST_ENABLE_AUDIO_MODERATION_WEBINAR';
