...
import { setStartWebinar1 } from '../base/conference/actions';
...
import {
    ...
    REQUEST_DISABLE_AUDIO_MODERATION_FOR_WEBINAR,
...
MiddlewareRegistry.register((store: IStore) => (next: Function) => (action: any)=> {
    ...
    console.log('isModertorrrrrrrrrrrrr',isModerator)
    ...
    case REQUEST_DISABLE_AUDIO_MODERATION_FOR_WEBINAR:{
    ...
    case REQUEST_ENABLE_AUDIO_MODERATION_FOR_WEBINAR:{
        // if (conference && MEDIA_TYPE.AUDIO )  {
        //     conference.sendCommand(NOTIFY_ALL_COMMAND, { attributes: notificationAttributes });
...
StateListenerRegistry.register(
   ...
   // Assuming this is part of your command handling logic
// function _onNotifyAllCommand(attributes: INotifyAllCommandAttributes = {}, { dispatch, getState }) {
//     // Extract notification attributes from the command
//     const notificationAttributes = attributes;

//     // You may need to loop through all participants and dispatch notifications
//     const participants = getRemoteParticipants(getState()); // Replace with your logic
//     participants.forEach(participant => {
//         dispatch(showNotification(notificationAttributes, NOTIFICATION_TIMEOUT_TYPE.MEDIUM));
//     });
// }
