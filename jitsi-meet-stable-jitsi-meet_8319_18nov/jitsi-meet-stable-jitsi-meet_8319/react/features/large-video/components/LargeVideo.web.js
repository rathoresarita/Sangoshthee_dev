...
import { isLocalParticipantModerator,getModerator } from '../../base/participants';
...
if(!webinarEnabled){
        ...
        console.log('wwwwwwwwwwwwwwww',webinarEnabled);
if(webinarEnabled && !isModerator) {

     console.log('largeVideoModeratorId ..........',largeVideoModeratorId )
            VideoLayout.updateLargeVideo(  largeVideoModeratorId , true, true);
...
//console.log('webbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbin',webinarEnabled)
    ...
    return {
        ...
        largeVideoModeratorId:largeVideoModerator?.id,
