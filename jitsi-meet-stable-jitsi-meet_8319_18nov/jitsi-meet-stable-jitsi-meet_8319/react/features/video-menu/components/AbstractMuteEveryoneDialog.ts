    ...
    constructor(props: P) {
        ...
        this.state = {
            ...
            content: props.content || props.t(props.isAudioModerationEnabled
               ...
               // 'dialog.muteEveryoneDialogModerationOn'//The participants can send a request to speak at any time
////'dialog.muteEveryoneDialog:The participants can unmute themselves at any time
        ...
        this.setState(state => {
            return {
                ...
                content: this.props.t(state.audioModerationEnabled
                    ? 'dialog.muteEveryoneDialog' : 'dialog.muteEveryoneDialogModerationOn'//The participants can send a request to speak at any time
                )
            };
        });//'dialog.muteEveryoneDialog:The participants can unmute themselves at any time
    }
