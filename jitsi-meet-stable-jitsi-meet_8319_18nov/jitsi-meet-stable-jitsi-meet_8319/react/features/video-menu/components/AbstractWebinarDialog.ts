...
import { enableWebinar ,disableWebinar,enableNotifications} from '../../participants-pane/actions.any';;
import {
...
import AbstractWebinar, {
    type Props as AbstractProps
} from './AbstractWebinar';
...
export default class AbstractWebinarDialog<P extends Props> extends
    ...
    constructor(props: P) {
        ...
        this.state = {
            ...
            content:  'Do you Want to Enable Webinar ?',
