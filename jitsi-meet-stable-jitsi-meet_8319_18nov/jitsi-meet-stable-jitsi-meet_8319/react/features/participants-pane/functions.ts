...
//import { onEnableWebinar } from './components/web/ParticipantsPane';
//import { WebinarMenu } from './components/web/WebinarMenu';
...
//import { WebinarState } from './components/web/WebinarState';
...
/**
 * Is Webinar opened or not.
 *
 * @param {IReduxState} state - Global state.
 * @returns {boolean}
 */
export const getWebinarMenuOpen = (state: IReduxState) => Boolean(getConferenceState(state).webinarEnabled);

// export const getWebinarMenuOpen = (state: IReduxState): boolean => {
//   return Boolean(getConferenceState(state)) ;
// };
...
export const getParticipantsPane = (stateful: IStateful) => {
    const state = toState(stateful);
    //const { participantsPane = {disable} } = state['features/base/config'];
    const { participantsPane = { disable: true } } = state['features/base/config'];
...
// //Is the Webinarmenu open.
export const getWebinarOpen = (state: IReduxState) => Boolean(getState(state)?.webinarEnabled);
...
//     const isWebinar=isWebinarMenuOpen(state)
...
//export function getParticipantPaneButtonProps(state: IReduxState ) {
    //let disabled = false;
  //  let visible;
    //const { webinarEnabled } = state['features/participants-pane'];

//  const isModerator = isLocalParticipantModerator(state);
//    const webinarOpen = getWebinarMenuOpen(state);

//    const isLocal=isParticipantNotModerator(state)
//  //const participant=getLocalParticipant(state)
//     //const menuOpen = WebinarState({isOpen})
//     //const visible = isModerator && !WebinarOpen;
//    // const visible = isModerator || (webinarOpen && !isModerator);
//    //const visible = !webinarOpen || isModerator;
//   // const visible = !webinarOpen || (!isModerator && webinarOpen);
//  // const visible=!webinarOpen || !isModerator
//    //const visible = !webinarOpen && isModerator;
//  //visible=!webinarOpen 

 
// // if(webinarOpen || isLocal){
...
// //    visible=true
// // }
// //visible=!webinarOpen?true:isModerator
// //visible=!webinarOpen?true:isLocal
// //visible=webinarOpen==false?true:isModerator
//  visible=!webinarOpen?true:isModerator
...
//    const isModerator = isLocalParticipantModerator(state);
//     //const webinarOpen = getWebinarMenuOpen(state);
//     const webinarEnabled = state['features/participants-pane'].webinarEnabled;
    
//     //const visible = !webinarOpen &&(!webinarEnabled && isModerator);
//   //const visible=webinarEnabled && isModerator
//    //const isLocal=isParticipantNotModerator(state)

//  let visible
//   if(webinarEnabled==false ){

//      visible=true
//   }
//   else if(webinarEnabled==true ){
// visible=isModerator 
//   }
  

// //const visible=webinarEnabled
