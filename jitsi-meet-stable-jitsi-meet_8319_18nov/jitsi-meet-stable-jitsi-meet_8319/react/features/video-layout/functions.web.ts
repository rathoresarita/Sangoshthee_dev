...
import{getModeratorCountForTileView} from './../filmstrip/functions.web'
...
export function getNotResponsiveTileViewGridDimensions(state: IReduxState, stageFilmstrip = false) {
    ...
    : stageFilmstrip ? activeParticipants.length : getNumberOfPartipantsForTileView(state)// Default behavior
   ...
   // const numberOfParticipants = stageFilmstrip ? activeParticipants.length : getNumberOfPartipantsForTileView(state);
    ...
    console.log('columnsToMaintainASquare',columnsToMaintainASquare)
    console.log('Colom..',columns)
    console.log('Rows...',rows)
    console.log('min..',minVisibleRows)
