...
import { getLocalParticipant, getModeratorIds,getModerator,isLocalParticipantModerator, isParticipantNotModerator } from '../../../base/participants/functions';
...
function _mapStateToProps(state: IReduxState, ownProps: { columnIndex: number;
    ...
    if (_currentLayout === LAYOUTS.TILE_VIEW || _verticalViewGrid || stageFilmstrip) {
        ...
        if ( !webinarEnabled&&!iAmRecorder && localScreenShare && index === localScreenShareIndex) {
            return {
                _disableSelfView: disableSelfView,
                _filmstripType: filmstripType,
          ...
          if ( webinarEnabled && !isModerator&&!iAmRecorder && localScreenShare && index === localScreenShareIndex) {
            return {
                _disableSelfView: disableSelfView,
                _filmstripType: filmstripType,
                _isLocalScreenShare: true,
