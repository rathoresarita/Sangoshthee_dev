...
import {
 calculateNonResponsiveTileViewDimensions,
    ...
    getModeratorCountForTileView,
    isStageFilmstripAvailable,
    isStageFilmstripTopPanel
    , showGridInVerticalView,calculateResponsiveTileViewDimensionsForModerator,
    calculateNonResponsiveTileViewDimensionsForModerator
} from './functions.web';
...
export function setTileViewDimensions() {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
      ...
      const  isModerator=isLocalParticipantModerator(state)
        ...
        const numberOfParticipants =  webinarEnabled && !isModerator
        ? getRemoteModeratorsCount(state)// Use a function to get moderator count
        : getNumberOfPartipantsForTileView(state); // Default behavior

//const numberOfParticipants=getNumberOfPartipantsForTileView(state)
// if(webinarEnabled && !isModerator){

// const numberOfModerators=getRemoteModeratorsCount(state)
...
//     width,
//     columns,
//     rows  } = disableResponsiveTiles


//     ? calculateNonResponsiveTileViewDimensions(state)
    
//     : calculateResponsiveTileViewDimensionsForModerator({
//         clientWidth,
//         clientHeight,
//         disableTileEnlargement,
//         maxColumns,
...
// }
        //const numberOfParticipants = getNumberOfPartipantsForTileView(state);
        const maxColumns = getMaxColumnCount(state);
        console.log('maxColoumn',maxColumns )
        console.log('disableResponsiveTiles',disableResponsiveTiles )
...
export function setHorizontalViewDimensions() {
    ...
    //    const numberOfRemoteParticipants =  webinarEnabled && !isModerator
    //     ? getModeratorCountForTileView(state) // Use a function to get moderator count
    //     : getRemoteParticipantCountWithFake(state); // Default behavior
...
export function setStageFilmstripViewDimensions() {
    ...
    //      const numberOfParticipants =  webinarEnabled && !isModerator
    //     ? getModeratorCountForTileView(state) // Use a function to get moderator count
    //    : state['features/filmstrip'].activeParticipants.length
